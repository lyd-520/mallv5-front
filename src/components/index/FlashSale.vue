...
export default {
  ...
  watch:{
    flashPromotions(newValue){
      let topColor=['#ffac13','#83c44e','#2196f3','#e53935','#00c0a5'];
      this.slideItems=newValue.map((flash,i) => {
          //{value: '高品质多功能头戴耳机', desc: '我的私人KTV', newPrice: '199', oldPrice: '249', topColor: '#ffac13', src: 'https://i8.mifile.cn/a1/pms_1551343984.14546114.jpg', url: 'https://www.mi.com/seckill/'},
          return {
            id:flash.id,
            value:flash.name,
            desc:flash.subTitle,
            newPrice:flash.flashPromotionPrice,
            oldPrice:flash.originalPrice,
